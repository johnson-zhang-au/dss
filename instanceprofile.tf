...
resource "aws_iam_role" "dss_role" {
  ...
  managed_policy_arns = [
    ...
    aws_iam_policy.policy_dss_eks_launch_conf.arn,
    aws_iam_policy.policy_dss_eks_autoscale.arn,
    aws_iam_policy.policy_dss_eks_iam.arn,
    aws_iam_policy.policy_dss_eks_linked_role.arn,
    aws_iam_policy.policy_dss_eks_iam_openid.arn,
    aws_iam_policy.policy_dss_eks_igw.arn,
    aws_iam_policy.policy_dss_eks_launch_template.arn,
